...
**Observações importantes:**
  ...
  2 - Vue resource é uma lib para o vueJS feita para realizar e receber requisiçôes HTTP de web servers, mais informa-
  ções em: https://github.com/pagekit/vue-resource.
